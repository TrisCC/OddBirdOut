  ...
  <div class="references">
    ...
    <ul>
      ...
      <li>
        ...
        &amp; Williams, K. D. (2014). Ostracism Online: A social media ostracism
        paradigm. <em>Behavior Research Methods</em>, <em>47</em>(2), 361–373.
      </li>
    </ul>
  </div>
</section>
...
<style>
  ...
  .references li {
    padding-left: 20px;
    border-left: 3px solid var(--bg-deeper);
    margin-bottom: 12px;
  }
